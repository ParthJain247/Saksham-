  ...
  <section class="section section-top">
      ...
      <Parallax speed={7}>
				<div>
					...
					<h2 class="dark-text">Hello World</h2>
					<p>
		...
		<section class="section section-grid">
			<div data-aos="fade-up-left" class="card" data-rellax-speed="1" data-rellax-xs-speed="3">
				<img class="card-img-top" src="https://images.unsplash.com/photo-1594708767771-a7502209ff51?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8cG9vciUyMGNoaWxkfGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&w=1000&q=80"/>
				<h2>Hello<span class="card-body secondary-text dot"></span></h2>
				<p>
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore et
						dicta consectetur incidunt omnis nam quis quidem nisi ipsa deserunt.
				</p>
			...
			<div data-aos="flip-down"class="card" data-rellax-speed="4" data-rellax-xs-speed="3">
				<img class="card-img-top" src="https://thumbs.dreamstime.com/b/indian-poor-children-street-mandu-india-poverty-major-issue-february-unidentified-120730284.jpg"/>
				<h2>World<span class=" card-body secondary-text dot"></span></h2>
				<p>
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore et
						dicta consectetur incidunt omnis nam quis quidem nisi ipsa deserunt.
				</p>
			...
			<div data-aos="fade-up-right" class="card" data-rellax-speed="7" data-rellax-xs-speed="3">
				<img class="card-img-top" src="https://images.pexels.com/photos/732613/pexels-photo-732613.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"/>
				<h2>Hello<span class="card-body secondary-text dot"></span></h2>
				<p>
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore et
						dicta consectetur incidunt omnis nam quis quidem nisi ipsa deserunt.
...
<div data-aos="fade-up" className="card shadow-lg p-3 mt-5  rounded float-left form-width"  >
<figure className="position-static">
  
<div className="card-header bg-transparent border-0  text-dark text-uppercase"><h3>Contribution </h3>
<img src="https://mc.webpcache.epapr.in/mcms.php?size=large&in=https://mcmscache.epapr.in/post_images/website_350/post_15657706/thumb.jpg" class="card-img-top"/></div>
  ...
  <br/>
  <div className="card-header bg-transparent border-0 text-dark text-uppercase"><h3 className="text-dark">Personal Info</h3>
