    ...
    if (!formValid) {
      return (
        <div className="CampaignsPage">
          ...
          <div class="explaination" data-rellax-speed="10">
            <div>
              <h2 class="">{this.props.cardTitle}</h2>
          ...
          {/* <section class="section section-grid">
            ...
            >
              ...
              <h2>
                ...
                <span class="card-body secondary-text dot"></span>
              </h2>
              <p>{this.props.imageContent}</p>
            </div>
            <div
      ...
      return (
        <div className="thankyou_details">
          ...
          <div className="container-fluid">
            <h1>Thank your</h1>
            <legend className="">
              We would like to thank you Mr.{this.state.name} for your
              contribution of rupees {this.state.data}
            </legend>
          </div>
        </div>
      );
