    ...
    return (
        <div className="FrontWorks">
            ...
            <div className="FrontWorks-Clips">
                <Link to="/Hunger" className="link-clip"><div className="FrontWorks-clipitems blue">
                    <img src="/images/1.png" alt="" />
                    <h2>Hunger</h2>
                    <p>We help the hunger people around we are. Everyone has a right to healthy meal.</p>
                </div></Link>
                <Link to="/Education"  className="link-clip"><div className="FrontWorks-clipitems yellow">
                    <img src="/images/2.png" alt="" />
                    <h2>Education</h2>
                    <p>We helped many children in completing their education and help them rise.</p>
                </div></Link>
                <Link to="/Health"  className="link-clip"><div className="FrontWorks-clipitems red">
                    <img src="/images/3.png" alt="" />
                    <h2>Medical Help</h2>
                    <p>We helped lots of people to get their medical treatment on time and save their lifes.</p>
                </div></Link>
                <Link to="/WomenEmpowerment"  className="link-clip"><div className="FrontWorks-clipitems green">
